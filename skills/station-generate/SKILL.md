...
从不同行业专家/领袖的视角解读今日新闻（3-5 个视角）。
每个视角用 H3 标记专家名字，正文 1-2 句话模拟该人视角的点评。

### 马斯克
今天最有意思的是...（从他关注的算力/火箭/自动驾驶角度）
...
注意：专家选择应匹配当日新闻主题，不是固定名单。
支持的专家 avatar 映射：马斯克🚀 贝佐斯📦 黄仁勋🎮 奥特曼🤖 Amodei🧠 李彦宏🔍 扎克伯格👤 纳德拉☁️ 李飞飞🎓，其他默认💡。
...
- `observations[]` — 今日观察（专家、avatar、点评）
