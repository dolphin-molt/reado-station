...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'xReader.title': 'X 订阅',
    'xReader.subtitle': '选择你订阅的账号，阅读该账号已进入 reado 的内容。',
    'xReader.accounts': '订阅账号',
  ...
  en: {
    ...
    'xReader.title': 'X Subscriptions',
    'xReader.subtitle': 'Pick a subscribed account and read the content already collected into reado.',
    'xReader.accounts': 'Accounts',
